...
// initOrganizationsServersBackgroundProcessesDestroyCmd initializes the organizations-servers-background-processes-destroy command.
func initOrganizationsServersBackgroundProcessesDestroyCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.OrganizationsServersBackgroundProcessesDestroyRequest](organizationsServersBackgroundProcessesDestroyCmdMeta); err != nil {
		return fmt.Errorf("invalid metadata for organizations-servers-background-processes-destroy: %w", err)
	}
	parent.AddCommand(cmd)
	return nil
}

// runOrganizationsServersBackgroundProcessesDestroyCmd executes the organizations-servers-background-processes-destroy command.
func runOrganizationsServersBackgroundProcessesDestroyCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.BackgroundProcesses.OrganizationsServersBackgroundProcessesDestroy(cmd.Context(), *req, sdkOpts...)
	if err != nil {

...
func initOrganizationsServersPhpSiteVersionShowCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.OrganizationsServersPhpSiteVersionShowRequest](organizationsServersPhpSiteVersionShowCmdMeta); err != nil {
		return fmt.Errorf("invalid metadata for organizations-servers-php-site-version-show: %w", err)
	}
	parent.AddCommand(cmd)
	return nil
}

// runOrganizationsServersPhpSiteVersionShowCmd executes the organizations-servers-php-site-version-show command.
func runOrganizationsServersPhpSiteVersionShowCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.Servers.OrganizationsServersPhpSiteVersionShow(cmd.Context(), *req, sdkOpts...)
	if err != nil {

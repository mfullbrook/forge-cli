...
var organizationsServersPhpVersionsIndexCmdMeta = []flagutil.FlagMeta{
	...
	{FlagName: "filter-version", FieldPath: "FilterVersion", Kind: flagutil.FlagKindString, Optional: true, Description: "string value"},
}

// initOrganizationsServersPhpVersionsIndexCmd initializes the organizations-servers-php-versions-index command.
func initOrganizationsServersPhpVersionsIndexCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.OrganizationsServersPhpVersionsIndexRequest](organizationsServersPhpVersionsIndexCmdMeta); err != nil {
		return fmt.Errorf("invalid metadata for organizations-servers-php-versions-index: %w", err)
	}
	parent.AddCommand(cmd)
	return nil
}

// runOrganizationsServersPhpVersionsIndexCmd executes the organizations-servers-php-versions-index command.
func runOrganizationsServersPhpVersionsIndexCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.Servers.OrganizationsServersPhpVersionsIndex(cmd.Context(), *req, sdkOpts...)
	if err != nil {

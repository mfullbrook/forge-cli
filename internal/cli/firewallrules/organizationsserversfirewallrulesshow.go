...
// initOrganizationsServersFirewallRulesShowCmd initializes the organizations-servers-firewall-rules-show command.
func initOrganizationsServersFirewallRulesShowCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.OrganizationsServersFirewallRulesShowRequest](organizationsServersFirewallRulesShowCmdMeta); err != nil {
		return fmt.Errorf("invalid metadata for organizations-servers-firewall-rules-show: %w", err)
	}
	parent.AddCommand(cmd)
	return nil
}

// runOrganizationsServersFirewallRulesShowCmd executes the organizations-servers-firewall-rules-show command.
func runOrganizationsServersFirewallRulesShowCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.FirewallRules.OrganizationsServersFirewallRulesShow(cmd.Context(), *req, sdkOpts...)
	if err != nil {

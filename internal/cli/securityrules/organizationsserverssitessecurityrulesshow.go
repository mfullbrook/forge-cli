...
// initOrganizationsServersSitesSecurityRulesShowCmd initializes the organizations-servers-sites-security-rules-show command.
func initOrganizationsServersSitesSecurityRulesShowCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.OrganizationsServersSitesSecurityRulesShowRequest](organizationsServersSitesSecurityRulesShowCmdMeta); err != nil {
		return fmt.Errorf("invalid metadata for organizations-servers-sites-security-rules-show: %w", err)
	}
	parent.AddCommand(cmd)
	return nil
}

// runOrganizationsServersSitesSecurityRulesShowCmd executes the organizations-servers-sites-security-rules-show command.
func runOrganizationsServersSitesSecurityRulesShowCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.SecurityRules.OrganizationsServersSitesSecurityRulesShow(cmd.Context(), *req, sdkOpts...)
	if err != nil {

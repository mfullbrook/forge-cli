...
// initOrganizationsServersScheduledJobsStoreCmd initializes the organizations-servers-scheduled-jobs-store command.
func initOrganizationsServersScheduledJobsStoreCmd(parent *cobra.Command) error {
...
// runOrganizationsServersScheduledJobsStoreCmd executes the organizations-servers-scheduled-jobs-store command.
func runOrganizationsServersScheduledJobsStoreCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.ScheduledJobs.OrganizationsServersScheduledJobsStore(cmd.Context(), *req, sdkOpts...)
	if err != nil {

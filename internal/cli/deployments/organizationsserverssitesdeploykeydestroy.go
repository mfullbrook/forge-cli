...
// initOrganizationsServersSitesDeployKeyDestroyCmd initializes the organizations-servers-sites-deploy-key-destroy command.
func initOrganizationsServersSitesDeployKeyDestroyCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.OrganizationsServersSitesDeployKeyDestroyRequest](organizationsServersSitesDeployKeyDestroyCmdMeta); err != nil {
		return fmt.Errorf("invalid metadata for organizations-servers-sites-deploy-key-destroy: %w", err)
	}
	parent.AddCommand(cmd)
	return nil
}

// runOrganizationsServersSitesDeployKeyDestroyCmd executes the organizations-servers-sites-deploy-key-destroy command.
func runOrganizationsServersSitesDeployKeyDestroyCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.Deployments.OrganizationsServersSitesDeployKeyDestroy(cmd.Context(), *req, sdkOpts...)
	if err != nil {

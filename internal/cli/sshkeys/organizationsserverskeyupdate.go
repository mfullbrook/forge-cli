...
func initOrganizationsServersKeyUpdateCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.OrganizationsServersKeyUpdateRequest](organizationsServersKeyUpdateCmdMeta); err != nil {
		return fmt.Errorf("invalid metadata for organizations-servers-key-update: %w", err)
	}
	parent.AddCommand(cmd)
	return nil
}

// runOrganizationsServersKeyUpdateCmd executes the organizations-servers-key-update command.
func runOrganizationsServersKeyUpdateCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.SSHKeys.OrganizationsServersKeyUpdate(cmd.Context(), *req, sdkOpts...)
	if err != nil {

...
var organizationsServersSitesDomainsUpdateCmdMeta = []flagutil.FlagMeta{
	...
	{FlagName: "allow-wildcard-subdomains", Shorthand: "a", FieldPath: "Body.AllowWildcardSubdomains", Kind: flagutil.FlagKindJSON, Optional: true, Annotations: `json:"allow_wildcard_subdomains,omitempty"`, Description: "Whether to allow wildcard subdomains for the domain."},
}

// initOrganizationsServersSitesDomainsUpdateCmd initializes the organizations-servers-sites-domains-update command.
func initOrganizationsServersSitesDomainsUpdateCmd(parent *cobra.Command) error {
...
// runOrganizationsServersSitesDomainsUpdateCmd executes the organizations-servers-sites-domains-update command.
func runOrganizationsServersSitesDomainsUpdateCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.Sites.OrganizationsServersSitesDomainsUpdate(cmd.Context(), *req, sdkOpts...)
	if err != nil {

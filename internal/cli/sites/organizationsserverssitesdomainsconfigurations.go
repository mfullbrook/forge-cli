...
// initOrganizationsServersSitesDomainsConfigurationsCmd initializes the organizations-servers-sites-domains-configurations command.
func initOrganizationsServersSitesDomainsConfigurationsCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.OrganizationsServersSitesDomainsConfigurationsRequest](organizationsServersSitesDomainsConfigurationsCmdMeta); err != nil {
		return fmt.Errorf("invalid metadata for organizations-servers-sites-domains-configurations: %w", err)
	}
	parent.AddCommand(cmd)
	return nil
}

// runOrganizationsServersSitesDomainsConfigurationsCmd executes the organizations-servers-sites-domains-configurations command.
func runOrganizationsServersSitesDomainsConfigurationsCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.Sites.OrganizationsServersSitesDomainsConfigurations(cmd.Context(), *req, sdkOpts...)
	if err != nil {

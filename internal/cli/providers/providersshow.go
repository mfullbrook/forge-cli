...
var providersShowCmdMeta = []flagutil.FlagMeta{
...
// runProvidersShowCmd executes the providers-show command.
func runProvidersShowCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.Providers.ProvidersShow(cmd.Context(), *req, sdkOpts...)
	if err != nil {

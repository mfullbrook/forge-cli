...
// initOrganizationsServersSitesIntegrationsReverbDestroyCmd initializes the organizations-servers-sites-integrations-reverb-destroy command.
func initOrganizationsServersSitesIntegrationsReverbDestroyCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.OrganizationsServersSitesIntegrationsReverbDestroyRequest](organizationsServersSitesIntegrationsReverbDestroyCmdMeta); err != nil {
		return fmt.Errorf("invalid metadata for organizations-servers-sites-integrations-reverb-destroy: %w", err)
	}
	parent.AddCommand(cmd)
	return nil
}

// runOrganizationsServersSitesIntegrationsReverbDestroyCmd executes the organizations-servers-sites-integrations-reverb-destroy command.
func runOrganizationsServersSitesIntegrationsReverbDestroyCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.Integrations.OrganizationsServersSitesIntegrationsReverbDestroy(cmd.Context(), *req, sdkOpts...)
	if err != nil {

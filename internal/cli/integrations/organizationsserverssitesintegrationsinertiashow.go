...
// initOrganizationsServersSitesIntegrationsInertiaShowCmd initializes the organizations-servers-sites-integrations-inertia-show command.
func initOrganizationsServersSitesIntegrationsInertiaShowCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.OrganizationsServersSitesIntegrationsInertiaShowRequest](organizationsServersSitesIntegrationsInertiaShowCmdMeta); err != nil {
		return fmt.Errorf("invalid metadata for organizations-servers-sites-integrations-inertia-show: %w", err)
	}
	parent.AddCommand(cmd)
	return nil
}

// runOrganizationsServersSitesIntegrationsInertiaShowCmd executes the organizations-servers-sites-integrations-inertia-show command.
func runOrganizationsServersSitesIntegrationsInertiaShowCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.Integrations.OrganizationsServersSitesIntegrationsInertiaShow(cmd.Context(), *req, sdkOpts...)
	if err != nil {

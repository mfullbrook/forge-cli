...
// initOrganizationsServersSitesIntegrationsReverbShowCmd initializes the organizations-servers-sites-integrations-reverb-show command.
func initOrganizationsServersSitesIntegrationsReverbShowCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.OrganizationsServersSitesIntegrationsReverbShowRequest](organizationsServersSitesIntegrationsReverbShowCmdMeta); err != nil {
		return fmt.Errorf("invalid metadata for organizations-servers-sites-integrations-reverb-show: %w", err)
	}
	parent.AddCommand(cmd)
	return nil
}

// runOrganizationsServersSitesIntegrationsReverbShowCmd executes the organizations-servers-sites-integrations-reverb-show command.
func runOrganizationsServersSitesIntegrationsReverbShowCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.Integrations.OrganizationsServersSitesIntegrationsReverbShow(cmd.Context(), *req, sdkOpts...)
	if err != nil {

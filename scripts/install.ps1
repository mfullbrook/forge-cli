#
# forge CLI Installation Script for Windows
# This script downloads and installs the latest version of the forge CLI
#
# Usage:
#   iwr -useb https://raw.githubusercontent.com/mfullbrook/forge-cli/main/scripts/install.ps1 | iex
#   or
#   Invoke-WebRequest -Uri https://raw.githubusercontent.com/mfullbrook/forge-cli/main/scripts/install.ps1 -UseBasicParsing | Invoke-Expression
#
# Options:
#   $env:FORGE_INSTALL_DIR - Installation directory (default: $env:LOCALAPPDATA\Programs\forge)
#   $env:FORGE_VERSION     - Specific version to install (default: latest)
#
...
# Configuration
$Repo = "mfullbrook/forge-cli"
$BinaryName = "forge.exe"
$DefaultInstallDir = Join-Path $env:LOCALAPPDATA "Programs\forge"
$InstallDir = if ($env:FORGE_INSTALL_DIR) { $env:FORGE_INSTALL_DIR } else { $DefaultInstallDir }
...
function Install-CLI {
    Write-ColorOutput "Installing forge CLI..." -Color Green
    ...
    $archiveName = "forge_Windows_$arch.zip"
    $downloadUrl = "https://github.com/$Repo/releases/download/$Version/$archiveName"

    Write-ColorOutput "Downloading from: $downloadUrl" -Color Cyan

    # Create temporary directory
    $tempDir = Join-Path $env:TEMP "forge-install-$(New-Guid)"
    ...
    try {
        ...
        Write-ColorOutput "forge $Version has been installed to $binaryPath" -Color Green
        ...
        Write-ColorOutput "Installation successful! Run 'forge --help' to get started." -Color Green

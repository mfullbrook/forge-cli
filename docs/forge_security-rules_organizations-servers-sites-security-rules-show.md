...
```
  forge security-rules organizations-servers-sites-security-rules-show --organization <value> --server-param 120041 --site 233971 --security-rule 908202
```
...
* `forge security-rules organizations-servers-sites-security-rules-show --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `forge security-rules organizations-servers-sites-security-rules-show --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)

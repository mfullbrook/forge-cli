...
```
  forge redirect-rules organizations-servers-sites-redirect-rules-destroy --organization <value> --server-param 280815 --site 178475 --redirect-rule 564958
```
...
* `forge redirect-rules organizations-servers-sites-redirect-rules-destroy --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `forge redirect-rules organizations-servers-sites-redirect-rules-destroy --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)

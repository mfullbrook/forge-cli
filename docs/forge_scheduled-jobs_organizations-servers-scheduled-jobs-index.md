## forge scheduled-jobs organizations-servers-scheduled-jobs-index
...
```
forge scheduled-jobs organizations-servers-scheduled-jobs-index [flags]
```

### Examples

```
  forge scheduled-jobs organizations-servers-scheduled-jobs-index --organization <value> --server-param 103524
```
...
```
  ...
  -h, --help                   help for organizations-servers-scheduled-jobs-index
...
* `forge scheduled-jobs organizations-servers-scheduled-jobs-index --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `forge scheduled-jobs organizations-servers-scheduled-jobs-index --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)

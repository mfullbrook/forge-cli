...
```
  forge scheduled-jobs organizations-servers-sites-scheduled-jobs-index --organization <value> --server-param 374166 --site 637674
```
...
* `forge scheduled-jobs organizations-servers-sites-scheduled-jobs-index --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `forge scheduled-jobs organizations-servers-sites-scheduled-jobs-index --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)

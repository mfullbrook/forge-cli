...
```
  forge backups organizations-servers-database-backups-update --organization <value> --server 450816 --backup-configuration 120221 --storage-provider-id 492562 --frequency hourly
```

...
```
  forge commands organizations-servers-sites-commands-output-show --organization <value> --server-param 23007 --site 629434 --command 794687
```
...
* `forge commands organizations-servers-sites-commands-output-show --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `forge commands organizations-servers-sites-commands-output-show --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)

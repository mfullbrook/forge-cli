...
```
  forge monitors organizations-servers-monitors-index --organization <value> --server-param 433479
```
...
* `forge monitors organizations-servers-monitors-index --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `forge monitors organizations-servers-monitors-index --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
